...
@Component
public class WhatIsTheCapitalOfCountryQuestionServiceImpl implements QuestionGenerator<CountryData> {
    private final String id = "what-is-the-capital-of-country";
    ...
    private Function<CountryData, String> getAnswerRetriever() {
        return CountryData::getCapitalCityName;
    }
    ...
    private String getLocalizedQuestion(CountryData countryData) {
        return localization.getLocalizedMessage("quiz.whatIsTheCapitalOfCountry", countryData.getCountryName());
    }
